            ...
            <div class="col-lg-12">
                ...
                <div class="card card-lightblue">
                    <div class="card-header">
                        <h3 class="card-title">Data Daftar Pesanan Selesai</h3>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                        $query = $koneksi->query("SELECT * FROM tb_pemesanan INNER JOIN tb_user ON tb_user.id_user=tb_pemesanan.id_user WHERE status = 'Sudah dibayar' ");
                        $nomor_urut = 1;
                        foreach ($query as $data) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="detail-pesanan-selesai.php?id=<?=$data['id_pemesanan'] ?>"
