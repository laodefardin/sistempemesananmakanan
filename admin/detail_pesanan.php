        ...
        <div class="row">
          ...
          ?>
                        ...
                        <form method="POST" action="">
                            <a href="daftar-pesanan" class="btn btn-success btn-sm">Kembali</a>
                            <?php
                                    $status = 'Sudah dibayar';
                                    if ($status == $data["status"]){?>
                                        <?php }else{ ?>
                                        <a href="konfirmasi-pembayaran?id=<?=$data['id_pemesanan'] ?>" class="btn btn-primary btn-sm">Konfirmasi Pembayaran</a>
                                        <?php } ?>
                        </form>
                    </div>
